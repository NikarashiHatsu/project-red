<template>
    <div class="bg-white p-6 rounded-lg shadow-lg border-l-4">
        ...
        <div class="grid grid-cols-12 grid-flow-row gap-6 mb-6">
        ...
        <div class="grid grid-cols-10 grid-flow-row gap-6 mb-6">
            <div class="col-span-2">
                ...
                <div v-if="storeInfo.whatsapp_number">
                    <a :href="'https://web.whatsapp.com/send?phone=' + storeInfo.whatsapp_number" target="_blank" class="bg-green-600 hover:bg-green-700 transition duration-300 ease-in-out rounded-md text-white px-2 py-1">
            ...
            <div class="col-span-2">
                ...
                <div v-if="storeInfo.youtube_link">
                    <a :href="storeInfo.youtube_link" target="_blank" class="bg-red-600 hover:bg-red-700 transition duration-300 ease-in-out rounded-md text-white px-2 py-1">
            ...
            <div class="col-span-2">
                ...
                <div v-if="storeInfo.facebook_link">
                    <a :href="storeInfo.facebook_link" target="_blank" class="bg-blue-600 hover:bg-blue-700 transition duration-300 ease-in-out rounded-md text-white px-2 py-1">
            ...
            <div class="col-span-2">
                ...
                <div v-if="storeInfo.instagram_link">
                    <a :href="storeInfo.instagram_link" target="_blank" class="bg-purple-600 hover:bg-purple-700 transition duration-300 ease-in-out rounded-md text-white px-2 py-1">
            ...
            <div class="col-span-2">
                ...
                <div v-if="storeInfo.twitter_link">
                    <a :href="storeInfo.twitter_link" target="_blank" class="bg-lightBlue-600 hover:bg-lightBlue-700 transition duration-300 ease-in-out rounded-md text-white px-2 py-1">
