<template>
    <div class="max-w-md mx-auto border-l border-r shadow-xl">
        <!-- Navbar -->
    ...
    export default {
        ...
        data() {
            return {
                ...
                navbarColorTheme: `bg-${this.$page.data.layout_picker.color_scheme_used}-500 text-white`,
                borderColorTheme: `border-${this.$page.data.layout_picker.color_scheme_used}-100`,
                productsSectionColorTheme: `bg-${this.$page.data.layout_picker.color_scheme_used}-50`,
                productsCount: this.$page.data.products.length,
                batasProduk: 0,
            }
        },
